...
- **Baan y AML (Egipto)**: [ERP Customization Failure](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.426.5108&rep=rep1&type=pdf) (Fuente: Alejandro Solanas)
...
- **SAP y [Revlon](https://revlon.com)**: [Revlon failed to fulfil product shipments of approximately "$64m" of net sales because of problems with an SAP ERP implementation](https://www.cio.com/article/2429865/enterprise-resource-planning-10-famous-erp-disasters-dustups-and-disappointments.html) ([Revlon Report](https://investors.revlon.com/news-releases/news-release-details/revlon-reports-second-quarter-2018-results)) (Fuente: Naval Alcalá)
