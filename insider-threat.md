...
* [Exempleado de Stradis Healthcare bloquea envíos de PPE para tratar pacientes de COVID-19](https://threatpost.com/healthcare-exec-stalls-critical-ppe-shipment/162855/)
  * **Fuente**: Alain Villagrasa Labrador
  * **Descripción**: Christopher Dobbins, exempleado de Stradis Healthcare, bloqueó envíos de equipos de protección personal (PPE) destinados a hospitales y centros de atención médica en Georgia, Estados Unidos. Dobbins, que había sido despedido de Stradis, accedió a la red de la empresa y bloqueó los envíos de PPE, lo que provocó retrasos en la entrega de equipos críticos para tratar a pacientes de COVID-19.
  * **Estrategia**: Para evitar este tipo de amenazas, las empresas deben implementar controles de acceso y monitoreo para proteger sus sistemas y datos. Esto incluye la revocación inmediata de los privilegios de acceso de los empleados que dejan la empresa, así como la implementación de políticas de seguridad claras y la capacitación de los empleados sobre las mejores prácticas de seguridad.
  * **Solución**: Una solución de gestión de identidades y accesos (IAM) como [Okta](https://www.okta.com/) puede ayudar a las empresas a proteger sus sistemas y datos mediante la gestión centralizada de los privilegios de acceso y la implementación de políticas de seguridad. Además, Okta también proporciona funciones de monitoreo y generación de informes para detectar comportamientos sospechosos y revocar los privilegios de acceso en caso de que un empleado deje la empresa.
