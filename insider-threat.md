...
* [El escándalo de Kobe Steel, la empresa japonesa que le vendió metales falsificados a General Motors, Boeing, Toyota (y otras 500 empresas)](https://www.bbc.com/mundo/noticias-41602077)
  ...
  * **Solución**: Un software que se podría utilizar para solventar la parte de control de acceso de los empleados, sería Azure AD (Azure Active Directory). Puede ser utilizado por los administradores de TI tanto para controlar el acceso como para requerir autenticación al acceder a recursos importantes de la empresa. El enlace a Azure AD es https://azure.microsoft.com/es-es/products/active-directory/. 
