...
* [Robo masivo de los datos personales de clientes de una sex-shop española en Internet](https://www.elmundo.es/tecnologia/2021/01/26/60100e5afdddffc80e8b4605.html)
  ...
  * **Solución**: Una posible solución reside en el uso de un software que permita la gestión del acceso del usuario (cuentas y permisos de cada usuario de la empresa). Con este tipo de software, además de la supervisión de las actividades del usuario, es más fácil detectar las amenazas internas. [Ekran System](https://www.ekransystem.com/es/product/access-management) ofrece a las empresas las herramientas necesarias relacionadas con la gestión de acceso del usuario.
