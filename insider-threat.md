...
* **Estrategia**: Morris debería haber utilizado un sistema de detección de anomalías en la red, de manera que rápidamente pudiera detectar el impacto que estaba provocando su código. Esta estrategia le habría permitido identificar la propagación del gusano y tomar medidas correctivas de manera oportuna. Al implementar esta solución, Morris podría haber mitigado el daño causado por el ataque y reducido su impacto en la red.
