...
* [Robo masivo de los datos personales de clientes de una sex-shop española en Internet](https://www.elmundo.es/tecnologia/2021/01/26/60100e5afdddffc80e8b4605.html)
  ...
  * **Solución**: Una posible solución reside en el uso de un software que permita la gestión de las cuentas y del acceso del usuario (Identity and Access Management - IAM). Además de la supervisión de las actividades del usuario, es más fácil proteger la información confidencial y detectar las amenazas internas. [Ekran System](https://www.ekransystem.com/es/product/access-management) ofrece a las empresas una serie de herramientas que facilitan dicha gestión.
